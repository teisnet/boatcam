...
Cam.prototype._request = function(options, callback) {
	...
	var req = http.request(reqOptions, function(res) {
		...
		res.on('end', function() {
			...
			parseSOAPString(xml, callback); // TEIS: Bug crashes server: "Cannot read property '0' of undefined"
		});
	});
...
Cam.prototype.getActiveSources = function() {
	...
	if (this.videoSources && this.videoSources.$) { // TEIS BUG FIX
	...
	if (!this.videoSources) {
		console.error("TEIS BUG CAUGHT cam.js line 463");
		return; // TEIS BUG fix
	}
